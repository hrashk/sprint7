...
public class RandomStringTest {
    ...
    public void randomStrings() {
        System.out.println(RandomStringUtils.secure().next(11));
        System.out.println(RandomStringUtils.secure().nextNumeric(13));
        System.out.println(RandomStringUtils.secure().nextAlphabetic(17));
        System.out.println(RandomStringUtils.secure().nextAlphanumeric(23));
        System.out.printf("autotest_%s@ya.ru", RandomStringUtils.secure().nextAlphanumeric(15));
    }
